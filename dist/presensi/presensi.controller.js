...
let PresensiController = class PresensiController {
    ...
    async create(file, createPresensiDto) {
...
__decorate([
    ...
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('foto', {
        storage: (0, multer_1.diskStorage)({
            ...
            filename: (req, file, cb) => {
                ...
                cb(null, `presensi-${uniqueSuffix}${(0, path_1.extname)(file.originalname)}`);
            },
        }),
    })),
    ...
    __metadata("design:paramtypes", [Object, create_presensi_dto_1.CreatePresensiDto]),
